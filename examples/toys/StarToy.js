...
void main()
{
//  vec2 p = ((gl_FragCoord.xy/u_resolution.xy * 2.0 - 1.0) - u_viewport.xy) /(u_viewport.zw/2.0)-1.0;
  vec2 p = (inverse(u_projection) * vec4((gl_FragCoord.xy/u_resolution.xy * 2.0 - 1.0),0.0,1.0)).xy;
