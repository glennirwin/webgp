...
//		vec2 xy = (inverse(u_projection) * vec4((-1.0 + 2.0*gl_FragCoord.xy/u_resolution.xy),1.0,1.0)).xy;
...
alpha = (1.0-sum.w)*alpha; // alpha/density saturation (the more a cloud layers density, the more the higher layers will be hidden)
...
// Vignetting
//		vec2 xy2 = (inverse(u_projection) * vec4((gl_FragCoord.xy/u_resolution.xy * 2.0 - 1.0),1.0,1.0)).xy;
//vec2 xy2 = (inverse(u_projection) * vec4(gl_FragCoord.xy / u_resolution.xy,1.0,1.0)).xy;
